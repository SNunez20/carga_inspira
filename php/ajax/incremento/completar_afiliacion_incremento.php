...
$cantidad_direccion_socio_padron = mysqli_num_rows($comprobar_direccion_socio_padron);


if ($cantidad_direccion_socio_padron > 0) {
    /** Se actualiza la dirección registrada en padrón */
