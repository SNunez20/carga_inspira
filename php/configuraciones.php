...
//DEV O DB TEST
const DB_TEST        = array("host" => "localhost", "user" => "root", "password" => "", "db" => "motor_de_precios_inspira");
const DB_CALL_TEST   = array("host" => "localhost", "user" => "root", "password" => "", "db" => "call");
const DB_ABMMOD_TEST = array("host" => "localhost", "user" => "root", "password" => "", "db" => "abmmod");
